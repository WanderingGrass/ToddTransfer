...
using System.Text;
using Transfer.Auth.Handlers;
using Transfer.Auth.Services;
...
namespace Transfer.Auth
{
    public static class Extensions
    {
        ...
        public static ITransferBuilder AddJwt(this ITransferBuilder builder, string sectionName = SectionName,
        ...
        private static ITransferBuilder AddJwt(this ITransferBuilder builder, JwtOptions options,
            Action<JwtBearerOptions> optionsFactory = null)
        {
            if (!builder.TryRegister(RegistryName))//表示可由多个线程同时访问的键/值对的线程安全集合
            {
                return builder;
            }
