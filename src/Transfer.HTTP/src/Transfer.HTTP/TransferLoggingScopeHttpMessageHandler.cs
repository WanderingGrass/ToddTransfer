...
{
    internal sealed class TransferLoggingScopeHttpMessageHandler : DelegatingHandler
    {
        private readonly ILogger _logger;
        private readonly HashSet<string> _maskedRequestUrlParts;
        private readonly string _maskTemplate;

        public TransferLoggingScopeHttpMessageHandler(ILogger logger, HttpClientOptions options)
        {
