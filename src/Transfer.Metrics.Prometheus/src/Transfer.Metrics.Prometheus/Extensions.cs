using Transfer.Metrics.Prometheus.Internals;
using Microsoft.AspNetCore.Builder;
using Microsoft.Extensions.DependencyInjection;
using Prometheus;
using Prometheus.SystemMetrics;

namespace Transfer.Metrics.Prometheus
{
    public static class Extensions
    {
        public static ITransferBuilder AddPrometheus(this ITransferBuilder builder)
        {
