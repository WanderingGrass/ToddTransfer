...
using Transfer.Tracing.Jaeger.Builders;
using Transfer.Tracing.Jaeger.Tracers;
using Jaeger;
...
namespace Transfer.Tracing.Jaeger
{
    public static class Extensions
    {
        ...
        public static ITransferBuilder AddJaeger(this ITransferBuilder builder, string sectionName = SectionName,
        ...
        public static ITransferBuilder AddJaeger(this ITransferBuilder builder,
        ...
        public static ITransferBuilder AddJaeger(this ITransferBuilder builder, JaegerOptions options,
            string sectionName = SectionName, Action<IOpenTracingBuilder> openTracingBuilder = null)
        {
            ...
            if (!options.Enabled)
            {
                var defaultTracer = TransferDefaultTracer.Create();
