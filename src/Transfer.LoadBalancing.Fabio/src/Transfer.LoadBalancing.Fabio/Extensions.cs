...
using Transfer.HTTP;
using Transfer.LoadBalancing.Fabio.Builders;
using Transfer.LoadBalancing.Fabio.Http;
using Transfer.LoadBalancing.Fabio.MessageHandlers;
using Microsoft.Extensions.DependencyInjection;

namespace Transfer.LoadBalancing.Fabio
{
    public static class Extensions
    {
        ...
        public static ITransferBuilder AddFabio(this ITransferBuilder builder, string sectionName = SectionName,
        ...
        public static ITransferBuilder AddFabio(this ITransferBuilder builder,
        ...
        public static ITransferBuilder AddFabio(this ITransferBuilder builder, FabioOptions fabioOptions,
        ...
        private static ITransferBuilder AddFabio(this ITransferBuilder builder, FabioOptions fabioOptions,
            HttpClientOptions httpClientOptions, Action<ITransferBuilder> registerConsul)
        {
        ...
        public static void AddFabioHttpClient(this ITransferBuilder builder, string clientName, string serviceName)
