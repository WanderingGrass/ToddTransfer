using System;
using System.Linq;
using Transfer.Discovery.Consul.Builders;
using Transfer.Discovery.Consul.Http;
using Transfer.Discovery.Consul.MessageHandlers;
using Transfer.Discovery.Consul.Models;
using Transfer.Discovery.Consul.Services;
using Transfer.HTTP;
...
namespace Transfer.Discovery.Consul
{
    public static class Extensions
    {
        ...
        public static ITransferBuilder AddConsul(this ITransferBuilder builder, string sectionName = SectionName,
        ...
        public static ITransferBuilder AddConsul(this ITransferBuilder builder,
        ...
        public static ITransferBuilder AddConsul(this ITransferBuilder builder, ConsulOptions options,
        ...
        public static void AddConsulHttpClient(this ITransferBuilder builder, string clientName, string serviceName)
        ...
        private static ServiceRegistration CreateConsulAgentRegistration(this ITransferBuilder builder,
