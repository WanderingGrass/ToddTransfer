...
using Transfer.MessageBrokers.CQRS.Dispatchers;
using Microsoft.Extensions.DependencyInjection;

namespace Transfer.MessageBrokers.CQRS
{
    public static class Extensions
    {
        ...
        public static ITransferBuilder AddServiceBusCommandDispatcher(this ITransferBuilder builder)
        {
            builder.Services.AddTransient<ICommandDispatcher, ServiceBusMessageDispatcher>();
            return builder;
        }

        public static ITransferBuilder AddServiceBusEventDispatcher(this ITransferBuilder builder)
        {
