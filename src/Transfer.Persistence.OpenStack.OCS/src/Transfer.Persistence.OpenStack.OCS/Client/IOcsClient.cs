...
using Transfer.Persistence.OpenStack.OCS.OcsTypes;
using Transfer.Persistence.OpenStack.OCS.OcsTypes.Definition;

namespace Transfer.Persistence.OpenStack.OCS.Client
{
