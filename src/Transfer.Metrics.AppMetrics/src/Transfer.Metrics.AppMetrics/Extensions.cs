...
using Transfer.Metrics.AppMetrics.Builders;
...
namespace Transfer.Metrics.AppMetrics
{
    public static class Extensions
    {
        ...
        public static ITransferBuilder AddMetrics(this ITransferBuilder builder,
        ...
        public static ITransferBuilder AddMetrics(this ITransferBuilder builder, MetricsOptions metricsOptions,
