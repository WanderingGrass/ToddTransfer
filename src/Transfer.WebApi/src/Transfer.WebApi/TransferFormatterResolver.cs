...
{
    internal sealed class TransferFormatterResolver : IJsonFormatterResolver
    {
        public static readonly IJsonFormatterResolver Instance = new TransferFormatterResolver();
