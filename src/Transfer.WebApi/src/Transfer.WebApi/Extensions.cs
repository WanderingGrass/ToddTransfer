...
using Transfer.WebApi.Formatters;
using Transfer.WebApi.Requests;
...
namespace Transfer.WebApi
{
    public static class Extensions
    {
        ...
        public static ITransferBuilder AddWebApi(this ITransferBuilder builder, Action<IMvcCoreBuilder> configureMvc = null,
        ...
        public static ITransferBuilder AddErrorHandler<T>(this ITransferBuilder builder)
