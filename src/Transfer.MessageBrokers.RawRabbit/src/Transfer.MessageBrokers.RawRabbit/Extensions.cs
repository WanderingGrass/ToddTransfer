...
using Transfer.MessageBrokers.RawRabbit.Builders;
using Transfer.MessageBrokers.RawRabbit.Processors;
using Transfer.MessageBrokers.RawRabbit.Publishers;
using Transfer.MessageBrokers.RawRabbit.Registers;
using Transfer.MessageBrokers.RawRabbit.Subscribers;
...
namespace Transfer.MessageBrokers.RawRabbit
{
    public static class Extensions
    {
        ...
        public static ITransferBuilder AddRabbitMq<TContext>(this ITransferBuilder builder, string sectionName = SectionName,
        ...
        public static ITransferBuilder AddRabbitMq<TContext>(this ITransferBuilder builder,
        ...
        public static ITransferBuilder AddRabbitMq<TContext>(this ITransferBuilder builder, RabbitMqOptions options,
            Func<IRabbitMqPluginRegister, IRabbitMqPluginRegister> plugins = null,
            RedisOptions redisOptions = null)
            where TContext : class, new()
            => builder.AddRabbitMq<TContext>(options, plugins, b => b.AddRedis(redisOptions ?? new RedisOptions()));

        private static ITransferBuilder AddRabbitMq<TContext>(this ITransferBuilder builder, RabbitMqOptions options,
            Func<IRabbitMqPluginRegister, IRabbitMqPluginRegister> plugins, Action<ITransferBuilder> registerRedis)
            where TContext : class, new()
        {
        ...
        private static void ConfigureBus<TContext>(ITransferBuilder builder,
            Func<IRabbitMqPluginRegister, IRabbitMqPluginRegister> plugins = null)
            where TContext : class, new()
        {
