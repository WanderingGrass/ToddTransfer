...
namespace Transfer.Docs.Swagger
{
    public static class Extensions
    {
        ...
        public static ITransferBuilder AddSwaggerDocs(this ITransferBuilder builder, string sectionName = SectionName)
        {
        ...
        public static ITransferBuilder AddSwaggerDocs(this ITransferBuilder builder,
        ...
        public static ITransferBuilder AddSwaggerDocs(this ITransferBuilder builder, SwaggerOptions options)
        {
